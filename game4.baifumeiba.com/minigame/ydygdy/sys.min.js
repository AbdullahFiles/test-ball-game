...
var guide_btn = "ألعاب أكثر";
var guide_href = "http://t.cn/RmLINnp";
var is_prize = "";
var sys_is_weixin = true;
var game_max_score = 100;

var oldTitle = "لعبة الأناناس";
...
function getpara()//تعمل للحصول على المعلمات
{
...
function requestAccess(argname) //احصل على قيمة get
{
...
function sureFocus(cb)
{
    var loginUrl = "http://www.guolaiwanba.com/login/?gameId=1003&from=share";
    ...
    ajaxLoad("http://www.guolaiwanba.com/login/api.php", "c=account&t=" + token, ajaxOnFocusResult, false);

    function ajaxOnFocusResult(evt) {
        if ((evt.currentTarget.readyState == 4) && (evt.currentTarget.status == 200 || evt.currentTarget.status == 0)) {
            var data = JSON.parse(evt.currentTarget.responseText);
...
function loadGame(isEnter)
{
    //var none1 = document.getElementById('loadingImg');
    var canvasdiv = document.getElementById('c2canvas');
